...
documents/
  index.html           Browsable library of all 568 documents
...
|---|---|---|
| `articles.json` | `articles` | 52 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 568 documents come
