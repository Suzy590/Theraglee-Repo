...
documents/
  index.html           Browsable library of all 595 documents
...
|---|---|---|
| `articles.json` | `articles` | 77 (five more every day — see `docs/articles.md`) |
| `checklists.json` | `checklists` | 6 (two more every day — see `docs/checklists.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 595 documents come
out of 953 source rows (the 374 prompt rows collapse into 11 collections).
