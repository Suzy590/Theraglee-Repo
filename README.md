...
documents/
  index.html           Browsable library of all 578 documents
...
|---|---|---|
| `articles.json` | `articles` | 62 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 578 documents come
