...
documents/
  index.html           Browsable library of all 642 documents
...
|---|---|---|
| `articles.json` | `articles` | 97 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 642 documents come
