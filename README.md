...
| `therapist-resources.json` | `therapist_resources` (the clinician library on the therapist dashboard; not rendered into `documents/`) | 90 (five more of every kind every day — see `docs/therapist-resources.md`) |
