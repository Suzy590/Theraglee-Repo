...
documents/
  index.html           Browsable library of all 590 documents
...
|---|---|---|
| `articles.json` | `articles` | 72 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 590 documents come
