...
documents/
  index.html           Browsable library of all 558 documents
...
|---|---|---|
| `articles.json` | `articles` | 42 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 558 documents come
