...
documents/
  index.html           Browsable library of all 563 documents
...
|---|---|---|
| `articles.json` | `articles` | 47 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 563 documents come
