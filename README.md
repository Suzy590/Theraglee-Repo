...
documents/
  index.html           Browsable library of all 635 documents
...
(keyword rules live in `THEMES` in the generator), which is why 635 documents come
out of 991 source rows (the journal prompt rows collapse into 11 collections).
