...
documents/
  index.html           Browsable library of all 538 documents
...
|---|---|---|
| `articles.json` | `articles` | 22 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 538 documents come
