...
documents/
  index.html           Browsable library of all 619 documents
...
(keyword rules live in `THEMES` in the generator), which is why 619 documents come
out of 975 source rows (the journal prompt rows collapse into 11 collections).
