...
documents/
  index.html           Browsable library of all 543 documents
...
|---|---|---|
| `articles.json` | `articles` | 27 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 543 documents come
