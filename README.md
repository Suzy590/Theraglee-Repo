...
documents/
  index.html           Browsable library of all 583 documents
...
|---|---|---|
| `articles.json` | `articles` | 67 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 583 documents come
