...
documents/
  index.html           Browsable library of all 548 documents
...
|---|---|---|
| `articles.json` | `articles` | 32 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 548 documents come
