...
documents/
  index.html           Browsable library of all 602 documents
...
| `checklists.json` | `checklists` | 8 (two more every day — see `docs/checklists.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 602 documents come
out of 958 source rows (the journal prompt rows collapse into 11 collections).
