...
documents/
  index.html           Browsable library of all 573 documents
...
|---|---|---|
| `articles.json` | `articles` | 57 (five more every day — see `docs/articles.md`) |
...
(keyword rules live in `THEMES` in the generator), which is why 573 documents come
