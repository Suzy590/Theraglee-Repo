...
Checks the 150 mental health trivia quizzes in `site/assets/trivia-sets.js` and
...
It asserts there are exactly 150 quizzes ("sets" in code), ten per topic, ten questions each with
